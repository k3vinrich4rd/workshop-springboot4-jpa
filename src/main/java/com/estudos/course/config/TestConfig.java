...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Foi chamado o método getCategories() para obter a lista de categorias associadas a cada produto
        //  e, em seguida, foi adicionado a categoria correspondente usando o método add().
        ...
        // Salva as associações atualizadas no banco de dados
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
        ...
        // Salva os usuários e pedidos no banco de dados usando os repositórios correspondentes.
        userRepository.saveAll(Arrays.asList(u1, u2));
        // Salva os pedidos no banco de dados usando o repositório correspondente.
